...
COMMAND_TO_EXEC="docker-compose --project-name ${PROJECTT_NAME} -f ${CURRENT_SCRIPT_DIR}/../03_erta_services/docker-compose.yml -f ${CURRENT_SCRIPT_DIR}/../../config/docker-compose.override.yml up -d "
